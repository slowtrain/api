...
-- DROP TABLE episode.if_user;

CREATE TABLE episode.if_user (
	id int4 NOT NULL,
	...
	CONSTRAINT if_user_idx1 PRIMARY KEY (id)
);

-- Permissions

ALTER TABLE episode.if_user OWNER TO episode;
GRANT ALL ON TABLE episode.if_user TO episode;
