...
export function getContent(element, isHtml) {
    ...
    if (isHtml) {
        ...
        /* modified 2019-11-21  for Internet Explorer  */
        if ((Browser.info.name === 'msie' || Browser.info.name === 'edge')){
