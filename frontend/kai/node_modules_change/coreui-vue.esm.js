...
var script$e = {
  ...
  computed: {
    classIcon: function classIcon() {
      ...
      // svg parent 2019.09.24 by cyh
      return ['nav-icon'];
    },
    // svg title  2019.09.24 by cyh
    svgIcon: function svgIcon() {
      let parser = new DOMParser()
      let xmlDoc=parser.parseFromString(this.icon,'text/xml')
      let fill    = xmlDoc.getElementsByTagName('svg')[0].getAttribute('fill')
      let viewBox = xmlDoc.getElementsByTagName('svg')[0].getAttribute('viewBox')
      let width   = xmlDoc.getElementsByTagName('svg')[0].getAttribute('width')
      let height  = xmlDoc.getElementsByTagName('svg')[0].getAttribute('height')
      let xmlns   = xmlDoc.getElementsByTagName('svg')[0].getAttribute('xmlns')
  ...
  methods: {
    handleClick: function handleClick(e) {
      e.preventDefault();
      if(e.target.parentElement === undefined){return}
...
var __vue_render__$e = function __vue_render__() {
  ...
  return _c("router-link", {
    ...
    staticClass: "nav-link nav-dropdown-toggle",
    on: { click: _vm.handleClick }
  },  [_c("svg", _vm._b({attrs:{fill: _vm.svgIcon["fill"], viewBox: _vm.svgIcon["viewBox"], width: _vm.svgIcon["width"], height: _vm.svgIcon["height"], xmlns: _vm.svgIcon["xmlns"]}}, "svg")
        ,[_c("path",{attrs:{d: _vm.svgIcon["d"]}})],2)
        ,_vm._v(_vm._s(_vm.name))
      ]
  ), _vm._v(" "), _c("ul", { staticClass: "nav-dropdown-items" }, [_vm._t("default")], 2)]);
};
...
var __vue_render__$f = function __vue_render__() {
  ...
  var _h = _vm.$createElement;
  var _c = _vm._self._c || _h;
  return _c("router-link", _vm._b({ class: _vm.classList, attrs: { to: _vm.url } }, "router-link")
          , [_c("i", _vm._b({}, "i"),
              [_c("svg", _vm._b({attrs:{fill: _vm.svgIcon["fill"], viewBox: _vm.svgIcon["viewBox"], width: _vm.svgIcon["width"], height: _vm.svgIcon["height"], xmlns: _vm.svgIcon["xmlns"]}}, "svg")
                ,[_c("path",{attrs:{d: _vm.svgIcon["d"]}})],2)
              ]
...
var script$g = {
  ...
  computed: {
    ...
    svgIcon: function svgIcon() {
      let parser = new DOMParser()
      let xmlDoc=parser.parseFromString(this.classes,'text/xml')
      let fill    = xmlDoc.getElementsByTagName('svg')[0].getAttribute('fill')
      let viewBox = xmlDoc.getElementsByTagName('svg')[0].getAttribute('viewBox')
      let width   = xmlDoc.getElementsByTagName('svg')[0].getAttribute('width')
      let height  = xmlDoc.getElementsByTagName('svg')[0].getAttribute('height')
...
var __vue_render__$g = function __vue_render__() {
  ...
  var _h = _vm.$createElement;
  var _c = _vm._self._c || _h;
  return _c("li", _vm._b({ class: _vm.classList },'li')
  , [_c("i", _vm._b({}, "i")  
    , [_c("svg", _vm._b({attrs:{fill: _vm.svgIcon[0]["fill"], viewBox: _vm.svgIcon[0]["viewBox"], width: _vm.svgIcon[0]["width"], height: _vm.svgIcon[0]["height"], xmlns: _vm.svgIcon[0]["xmlns"]}}, "svg")
        ,[_c("path",{attrs:{d: _vm.svgIcon[0]["d"]}})],2)
      ]      
  ),_c("span",{},[_vm._v(_vm._s(_vm.name))])]    
  , 2);
};
