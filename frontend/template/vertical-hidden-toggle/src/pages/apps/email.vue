          ...
          <div class="menu-bar">
            ...
            <ul class="profile-list">
              ...
              <li class="profile-list-item">
                <a href="javascript:void(0);">
                  <span class="pro-pic">
                    <img src="../../assets/images/faces/face25.jpg" alt />
                  </span>
                  <div class="user">
              ...
              <li class="profile-list-item">
                <a href="javascript:void(0);">
                  <span class="pro-pic">
                    <img src="../../assets/images/faces/face10.jpg" alt />
                  </span>
                  <div class="user">
              ...
              <li class="profile-list-item">
                <a href="javascript:void(0);">
                  <span class="pro-pic">
                    <img src="../../assets/images/faces/face9.jpg" alt />
                  </span>
                  <div class="user">
          ...
          <div class="message-body">
            ...
            <div class="message-content">
              ...
              <p>
                ...
                >
                once the design is approved and necessary improvements are made.
              </p>
              <p>
                <br />
