...
export default new Router({
  ...
  scrollBehavior: () => ({ y: 0 }),
  mode: "history",
  // base: "/justdo-vue-pro/preview/horizontal-default-light/",
  routes: [
    {
      path: "/auth",
      component: {
      ...
      children: [
        {
          path: "testform",
          name: "testform",
          component: () => import("@/views/design/TestForm")
        }
      ]
    },
    {
      ...
      children: [
        {
          path: "platform",
          name: "platform",
          component: () => import("@/views/info/platform/Platform")
        },
        {
          path: "use",
          name: "use",
          component: () => import("@/views/info/procedure/Use")
        },
        {
          path: "register",
          name: "register",
          component: () => import("@/views/info/procedure/Register")
        }
      ]
    },
    {
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              path: "usergroup",
              name: "usergroup",
              component: () => import("@/views/system/usergroup/Usergroup")
            },
            {
              path: "role",
              name: "role",
          ...
          children: [
            {
              path: "designer",
              name: "designer",
              component: () => import("@/views/system/workflow/WFDesigner")
            },
            {
              path: "action",
              name: "action",
              component: () => import("@/views/system/action/Action")
            },
            {
              path: "assignment",
              name: "assignment",
              component: () => import("@/views/system/assignment/Assignment")
            }
          ]
        },
        /*
        ...
        children: [
          {
            path: "application",
            name: "application",
            component: () => import("@/views/system/application/Application")
          },
          {
            path: "organization",
            name: "organization",
          ...
          },
          {
            path: "domain",
            name: "domain",
            component: () => import("@/views/system/domain/Domain")
          },
          {
            path: "classification",
            name: "classification",
            component: () => import('@/views/system/classification/Classification')
          },
          {
            path: "navigator",
            name: "navigator",
            component: () => import('@/views/system/navigator/Navigator')
          },
          {
            path: "scheduler",
            name: "scheduler",
            component: () => import('@/views/system/scheduler/Scheduler')
          }
        ]
      },
      ]
