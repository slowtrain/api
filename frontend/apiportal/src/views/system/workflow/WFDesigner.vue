...
export default {
  ...
  computed: {
    ...
    visibleAction: function () {
      return this.actualObject !== undefined && this.actualObject.constructor.name === 'Connector'
    },
    visibleExpression: function () {
      return this.actualObject !== undefined && this.actualObject.constructor.name === 'Node' && this.actualObject.shape.shape === 'Decision'
    },
    visibleAssignment: function () {
      let result = this.actualObject !== undefined
      result = result && this.actualObject.constructor.name === 'Node'
  ...
  methods: {
    ...
    contextMenuBeforeItemRender: function () {
...
<style>
  ...
  @import '/src/assets/css/workflow.css';
