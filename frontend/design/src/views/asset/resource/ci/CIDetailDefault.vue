<!--
 Class Name  : CIDetailDefault.vue
 Description : IT 자원 > 상세 기본 정보
...
<template>
  <div>
    ...
    <b-row>
      ...
      <div class="form-group col-md-1">
        <label>{{labels.isbfi}}</label>
        <el-switch v-model="listGrid.currentData.isbfi" class="formdata sm" disabled="disabled"></el-switch>
      </div>
      <div class="form-group col-md-1">
        <label>{{labels.istaddm}}</label>
        <el-switch v-model="listGrid.currentData.istaddm" class="formdata sm" disabled="disabled"></el-switch>
      </div>
      <div class="form-group col-md-1">
        <label>{{labels.iswhatchall}}</label>
        <el-switch v-model="listGrid.currentData.iswhatchall" class="formdata sm" disabled="disabled"></el-switch>
      </div>
      <div class='form-group col-md-2'>
...
export default {
  name: 'CI',
  props: ['labels', 'comboData', 'detailType', 'listGrid'],
  components: {
    'Class': Class,
    'Location': Location
  },
